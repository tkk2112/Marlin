...
#define STRING_CONFIG_H_AUTHOR "(tkk2112, nanomaxx sc-10)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Nanomaxx SC-10"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "8978b83c-890f-4647-a0fa-8099abe82071"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 39.53
    #define DEFAULT_Ki 4.60
    #define DEFAULT_Kd 84.99
  #endif
#endif // PIDTEMP
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 140.041 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -60, -10, -1 }
...
#define XY_PROBE_FEEDRATE (195*60)
...
#define Y_CLIP_SAFE_MARGIN 15

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS -4
#define Y_MIN_POS (-8 - Y_CLIP_SAFE_MARGIN)
#define Z_MIN_POS 0
...
#define Y_BED_SIZE (Y_MAX_POS - 2 * Y_CLIP_SAFE_MARGIN)
...
//#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 60, 30, 30, 30 } // (mm) Left, Front, Right, Back insets
